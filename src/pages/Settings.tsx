...
export default function Settings() {
  ...
  const handleUpdatePin = () => {
    if (!storage.verifyPin(currentPin)) return toast.error("Current PIN is incorrect");
    ...
    <div className="min-h-screen romantic-gradient relative pb-20">
      ...
      <div className="container mx-auto px-5 py-10 max-w-2xl relative z-10">
        ...
        <div className="text-center fade-up mb-8">
          ...
          <p className="text-muted-foreground">Customize your beautiful space 💖</p>
        </div>
        ...
        <div className="space-y-8">
          ...
          {/* THEME */}
          <Card className="p-6 section-card fade-up" style={{ animationDelay: "0.1s" }}>
            <div className="flex items-center gap-3 mb-3">
              {theme === "light" ? (
          ...
          {/* PIN */}
          <Card className="p-6 section-card fade-up" style={{ animationDelay: "0.2s" }}>
            <div className="flex items-center gap-3 mb-3">
            ...
            <div className="space-y-3">
              ...
              <Input type="password" placeholder="Confirm New PIN" value={confirmNewPin}
                onChange={(e) => setConfirmNewPin(e.target.value)} />
              <Button className="w-full" onClick={handleUpdatePin}>Update PIN</Button>
            </div>
          </Card>

          {/* CLEAR DATA */}
          <Card className="p-6 section-card fade-up" style={{ animationDelay: "0.3s" }}>
            <div className="flex items-center gap-3 mb-3">
              <Trash2 className="w-5 h-5 text-rose-600" />
              <h2 className="text-xl font-semibold text-rose-600">Start Again</h2>
            </div>

            <p className="text-sm text-foreground/70 mb-4">
              Clears PIN, name, theme, favorites, messages & all app memory and start again.
            </p>
